...
export const commonRules = {
  ...
  firstName: [
    ...
    { pattern: patterns.name, message: "First name can only contain letters and spaces" },
  ],
  lastName: [
    { required: true, message: "Last name is required" },
    { minLength: 2, message: "Last name must be at least 2 characters" },
    { pattern: patterns.name, message: "Last name can only contain letters and spaces" },
  ],
  phone: [{ pattern: patterns.phone, message: "Please enter a valid phone number" }],
}
