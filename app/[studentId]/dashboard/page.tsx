...
import { ArrowUpRight, BookOpen, FileText, LineChart, Upload } from "lucide-react"
        ...
        recentFeedback: [
          {
            ...
            teacher: "Dr. Smith",
            feedback: "Good work on the problem-solving section. Focus more on showing your work clearly.",
            date: "2 days ago",
          },
          {
            id: 2,
            ...
            feedback: "Excellent lab work. Your methodology is clear and your analysis is thorough.",
            date: "3 days ago",
          },
          {
            id: 3,
            ...
            teacher: "Ms. Williams",
            feedback: "Your writing demonstrates strong critical thinking. Work on varying your sentence structure.",
            date: "5 days ago",
          },
        ],
      }
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back, Student! Here's an overview of your progress.</p>
        </div>
        <div className="flex items-center gap-2">
          <Button className="neo-brutalism-button" disabled={isLoading}>
      ...
      {/* Stats Cards */}
      <LoadingWrapper isLoading={isLoading} skeleton={<DashboardStatsSkeleton />}>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="neo-brutalism-card">
            ...
            <CardContent>
              <div className="text-2xl font-black">{dashboardData?.stats.overallProgress}%</div>
              <p className="text-xs text-muted-foreground">+2% from last month</p>
              <Progress value={dashboardData?.stats.overallProgress} className="mt-2 neo-brutalism-progress" />
            </CardContent>
          </Card>
          <Card className="neo-brutalism-card">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-bold">Courses Enrolled</CardTitle>
              <BookOpen className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-black">{dashboardData?.stats.coursesEnrolled}</div>
              <p className="text-xs text-muted-foreground">3 in progress, 2 completed</p>
            </CardContent>
          </Card>
          <Card className="neo-brutalism-card">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-bold">Pending Assignments</CardTitle>
              <FileText className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-black">{dashboardData?.stats.pendingAssignments}</div>
          ...
          <Card className="neo-brutalism-card">
            ...
            <CardContent>
              <div className="text-2xl font-black">{dashboardData?.stats.averageScore}%</div>
        ...
        >
          <Card className="md:col-span-2 lg:col-span-3 neo-brutalism-card">
            <CardHeader>
              ...
              <CardDescription>Latest comments from your teachers</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Tabs defaultValue="upcoming" className="neo-brutalism-tabs">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/dashboard/assignments">
              <Button variant="outline" size="sm" className="gap-1 neo-brutalism-button-outline" disabled={isLoading}>
                View All
                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                      <div className="grid gap-1">
                        <div className="font-bold">Mathematics Assignment #{i}</div>
                        <div className="text-sm text-muted-foreground">Due in {i + 1} days</div>
                      </div>
                      <Button size="sm" className="neo-brutalism-button-sm" disabled={isLoading}>
                        View
                      </Button>
                    </div>
                  ))}
                  ...
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      <div className="grid gap-1">
                        ...
                        <div className="text-sm text-muted-foreground">Submitted {i} days ago</div>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="text-sm font-bold">Grade: {85 + i}%</div>
                        <Button
                          size="sm"
                          variant="outline"
